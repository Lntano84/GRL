...
**Latest build: 16 pages.** All 12 cited references have been metadata-checked and resolve;
Tectonic still reports three non-fatal overfull boxes and a legacy font warning. The draft is
within the page limit; the remaining warnings are non-fatal layout/encoding cleanup items.
